...
def main():
    ...
    transformations = [v2.ToImageTensor(), v2.ConvertImageDtype(), v2.Normalize((0.1307,), (0.3081,))]
    # dataset1 = datasets.MNIST('../data', train=True, download=True,
    #                    transform=transform)
    
    dataset1 = CustomMNIST('./dataset', transform=v2.Compose([v2.PILToTensor()] + transformations))
    ...
    folder_name = f"{args.log_folder}/CNN/epochs={args.n_epochs}_lr={args.lr}"
